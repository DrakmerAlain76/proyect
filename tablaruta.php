...
<td><?php echo $row['ru_ci'];?></td>
<th><a href="eliminarutas.php? ruta=<?php echo
$row['ruta'];?>"><img src="imagenes/basura.jpg" width="30" height="24" ></a></td>
<th><a href="modificaruta.php? ruta=<?php echo
$row['ruta'];?>"><img src="imagenes/actualizar.png"width="30" height="24" ></a></td>
<?php
}
}
else{
